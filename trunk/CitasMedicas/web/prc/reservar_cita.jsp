                                        ...
                                        <td class="${pageScope.estilo}" width="107" align="center">
                                            <c:forEach var="martes" items="${horarioMartes}">
                                                <c:if test="${atencion.horaInicio == martes.horaInicio && atencion.minutoInicio == martes.minutoInicio}">
                                                    <c:choose>
                                                        <c:when test="${martes.cita == null}"> <!-- Si existe cita -->
                                                        ...
                                                        <c:otherwise> <!-- Si no existe cita -->
                                                            <c:choose>
                                                                <c:when test="${martes.cita.paciente.personaId==usuario.persona.personaId}"> <!--Cita del paciente-->
                                                                    <c:choose>
                                                                        <c:when test="${martes.cita.estado=='RESERVADO'}">
                                        ...
                                        <td class="${pageScope.estilo}" width="107" align="center">
                                            <c:forEach var="miercoles" items="${horarioMiercoles}">
                                                <c:if test="${atencion.horaInicio == miercoles.horaInicio && atencion.minutoInicio == miercoles.minutoInicio}">
                                                    <c:choose>
                                                        <c:when test="${miercoles.cita == null}"> <!-- Si existe cita -->
                                                        ...
                                                        <c:otherwise> <!-- Si no existe cita -->
                                                            <c:choose>
                                                                <c:when test="${miercoles.cita.paciente.personaId==usuario.persona.personaId}"> <!--Cita del paciente-->
                                                                    <c:choose>
                                                                        <c:when test="${miercoles.cita.estado=='RESERVADO'}">
                                        ...
                                        <td class="${pageScope.estilo}" width="107" align="center">
                                            <c:forEach var="jueves" items="${horarioJueves}">
                                                <c:if test="${atencion.horaInicio == jueves.horaInicio && atencion.minutoInicio == jueves.minutoInicio}">
                                                    <c:choose>
                                                        <c:when test="${jueves.cita == null}"> <!-- Si existe cita -->
                                                        ...
                                                        <c:otherwise> <!-- Si no existe cita -->
                                                            <c:choose>
                                                                <c:when test="${jueves.cita.paciente.personaId==usuario.persona.personaId}"> <!--Cita del paciente-->
                                                                    <c:choose>
                                                                        <c:when test="${jueves.cita.estado=='RESERVADO'}">
                                        ...
                                        <td class="${pageScope.estilo}" width="107" align="center">
                                            <c:forEach var="viernes" items="${horarioViernes}">
                                                <c:if test="${atencion.horaInicio == viernes.horaInicio && atencion.minutoInicio == viernes.minutoInicio}">
                                                    <c:choose>
                                                        <c:when test="${viernes.cita == null}"> <!-- Si existe cita -->
                                                        ...
                                                        <c:otherwise> <!-- Si no existe cita -->
                                                            <c:choose>
                                                                <c:when test="${viernes.cita.paciente.personaId==usuario.persona.personaId}"> <!--Cita del paciente-->
                                                                    <c:choose>
                                                                        <c:when test="${viernes.cita.estado=='RESERVADO'}">
                                        ...
                                        <td class="${pageScope.estilo}" width="107" align="center">
                                            <c:forEach var="sabado" items="${horarioSabado}">
                                                <c:if test="${atencion.horaInicio == sabado.horaInicio && atencion.minutoInicio == sabado.minutoInicio}">
                                                    <c:choose>
                                                        <c:when test="${sabado.cita == null}"> <!-- Si existe cita -->
                                                        ...
                                                        <c:otherwise> <!-- Si no existe cita -->
                                                            <c:choose>
                                                                <c:when test="${sabado.cita.paciente.personaId==usuario.persona.personaId}"> <!--Cita del paciente-->
                                                                    <c:choose>
                                                                        <c:when test="${sabado.cita.estado=='RESERVADO'}">
                                        ...
                                        <td class="${pageScope.estilo}" width="107" align="center">
                                            <c:forEach var="domingo" items="${horarioDomingo}">
                                                <c:if test="${atencion.horaInicio == domingo.horaInicio && atencion.minutoInicio == domingo.minutoInicio}">
                                                    <c:choose>
                                                        <c:when test="${domingo.cita == null}"> <!-- Si existe cita -->
                                                        ...
                                                        <c:otherwise> <!-- Si no existe cita -->
                                                            <c:choose>
                                                                <c:when test="${domingo.cita.paciente.personaId==usuario.persona.personaId}"> <!--Cita del paciente-->
                                                                    <c:choose>
                                                                        <c:when test="${domingo.cita.estado=='RESERVADO'}">
