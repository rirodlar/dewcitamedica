        ...
        <div id="main_loguin">
            <div class="loguin_bg">
            	<div style="padding-left:30px; float:left; width:162px">
                    <a href="home.jsp"><img src="<%=request.getContextPath()%>/resources/img/logo.png" alt="" title="" width="162" height="54" border="0" /></a>
                </div>
                <div style="float:right; padding-right:30px;"><img src="<%=request.getContextPath()%>/resources/img/d001.gif" width="165" height="230" /></div>
